/**
 * Floral Pink Wedding Invitation Template
 * Romantic floral theme, cursive Great Vibes headers, soft pink & rose color palette.
 */
export async function render(pageConfig, guestName) {
    ...
    // Colors
    const primary = '#D88C9A'; // Rose Pink
    const secondary = '#F3E8EE'; // Soft Lavender Cream
    const textDark = '#4E363C'; // Deep Mauve
    const textMuted = '#7D6067';
    const bgLight = '#FFF9FA';

    // Inject fonts & styles
    if (!document.getElementById('floral-pink-styles')) {
        const style = document.createElement('style');
        style.id = 'floral-pink-styles';
        style.innerHTML = `
            ...
            .pink-serif { font-family: 'Playfair Display', serif; }
            .pink-cursive { font-family: 'Great Vibes', cursive; }
            .pink-sans { font-family: 'Poppins', sans-serif; }
            ...
            /* Floral patterns background simulation */
            .bg-floral-pattern {
                position: relative;
            }
            .bg-floral-pattern::after {
                content: '';
                position: absolute;
                inset: 0;
                background-image: radial-gradient(${primary}15 1px, transparent 1px);
    ...
    if (stories && stories.length > 0) {
        const storyItems = stories.map((s, index) => {
            ...
            const imgHtml = s.image_url ? `<img src="${s.image_url}" alt="${s.title}" class="rounded-2xl max-w-full h-48 object-cover mb-4 mx-auto border border-pink-100 shadow-sm">` : '';
            ...
            return `
                <div class="relative flex flex-col md:flex-row items-center justify-between mb-16 w-full ${isEven ? 'md:flex-row-reverse' : ''}">
                    ...
                    <div class="w-full md:w-[45%] pl-12 md:pl-0">
                        <div class="bg-white rounded-3xl p-6 shadow-sm border border-pink-100/50 hover:shadow-md transition-shadow">
                            ...
                            <h4 class="pink-serif text-xl font-bold text-slate-800 mb-2">${s.title}</h4>
                            ${imgHtml}
        ...
        storyHtml = `
            <section id="our-story" class="py-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto bg-floral-pattern">
                <div class="text-center mb-16 relative z-10">
                    <span class="text-wedding-primary pink-serif tracking-[0.2em] uppercase text-xs font-bold">Kisah Kasih Kami</span>
                    <h2 class="pink-cursive text-5xl md:text-6xl text-wedding-primary mt-2">Perjalanan Cinta</h2>
                </div>
    ...
    if (gift && gift.bank_name && gift.account_number) {
        giftHtml = `
            <section id="digital-gift" class="py-20 px-4 bg-white border-t border-b border-pink-50">
                <div class="max-w-2xl mx-auto text-center">
                    <span class="text-wedding-primary pink-serif tracking-[0.2em] uppercase text-xs font-bold">Kado Digital</span>
                    <h2 class="pink-cursive text-5xl text-wedding-primary mt-2 mb-4">Hadiah Kasih</h2>
                    ...
                    <div class="bg-[#FFFDFE] rounded-3xl p-8 shadow-sm border border-[#FCECEF] max-w-sm mx-auto relative overflow-hidden">
                        <div class="absolute right-6 top-4 text-wedding-primary text-6xl pointer-events-none font-black select-none tracking-widest whitespace-nowrap opacity-5">GIFT</div>
                        ...
                        <button id="copy-btn" class="w-full btn-pink-primary text-xs py-3 rounded-full font-semibold flex items-center justify-center gap-2">
        ...
        <div id="invitation-cover" class="fixed inset-0 z-50 flex flex-col items-center justify-center text-center px-4 bg-cover bg-center transition-all duration-1000" style="background-image: linear-gradient(rgba(78,54,60,0.5), rgba(78,54,60,0.85)), url('https://images.unsplash.com/photo-1543807535-eceef0bc6599?auto=format&fit=crop&q=80&w=1200');">
            <div class="max-w-2xl mx-auto text-white flex flex-col items-center">
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-3xl p-6 shadow-xl border border-white/20 max-w-sm mb-10 w-full">
                    ...
                    <h3 class="pink-serif text-2xl font-bold text-white tracking-wide">${guestName}</h3>
                </div>
                
                <button id="open-invitation-btn" class="btn-pink-primary text-sm font-semibold tracking-wider px-8 py-4 rounded-full flex items-center gap-3 shadow-lg shadow-black/20">
        ...
        <main class="w-full flex-grow opacity-0 transition-opacity duration-1000" id="main-content">
            ...
            <section class="min-h-screen flex flex-col items-center justify-center text-center px-4 relative overflow-hidden bg-cover bg-center" style="background-image: linear-gradient(rgba(255,249,250,0.9), rgba(255,249,250,0.95)), url('https://images.unsplash.com/photo-1543807535-eceef0bc6599?auto=format&fit=crop&q=80&w=800');">
                <div class="max-w-2xl mx-auto z-10 py-16">
                    ...
                    <!-- Countdown Timer -->
                    <div class="mt-12 bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-sm border border-pink-100/50 max-w-lg mx-auto">
                        ...
                        <div class="grid grid-cols-4 gap-4" id="countdown-timer">
                            <div class="bg-[#FFFDFE] rounded-2xl p-3 border border-[#FCECEF]">
            ...
            <section id="bride-groom" class="py-24 px-4 sm:px-6 lg:px-8 text-center max-w-5xl mx-auto">
                <div class="pink-serif italic text-base md:text-lg text-wedding-primary max-w-2xl mx-auto px-4 mb-16 leading-relaxed">
                    "${quote}"
                </div>
                
                <h2 class="pink-cursive text-5xl md:text-6xl text-wedding-primary mb-16">Kedua Mempelai</h2>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
                    <!-- Groom Card -->
                    <div class="bg-white rounded-3xl p-8 shadow-sm border border-pink-100 flex flex-col items-center">
                        <div class="w-40 h-40 rounded-full overflow-hidden border-4 border-wedding-secondary shadow-md mb-6 animate-pulse">
                            <img src="${groomImage}" alt="Groom Avatar" class="w-full h-full object-cover">
                        </div>
                        <h3 class="pink-serif text-2xl font-bold text-slate-900">${groom.name || ''}</h3>
                    ...
                    <div class="bg-white rounded-3xl p-8 shadow-sm border border-pink-100 flex flex-col items-center">
                        ...
                        <h3 class="pink-serif text-2xl font-bold text-slate-900">${bride.name || ''}</h3>
            ...
            <section id="events" class="py-24 px-4 bg-wedding-secondary/20 border-t border-b border-wedding-primary/5">
                <div class="max-w-4xl mx-auto text-center">
                    <span class="text-wedding-primary pink-serif tracking-[0.2em] uppercase text-xs font-bold">Waktu & Tempat</span>
                    <h2 class="pink-cursive text-5xl md:text-6xl text-wedding-primary mt-2 mb-16">Acara Pernikahan</h2>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <!-- Akad Nikah -->
                        <div class="bg-white rounded-3xl p-8 shadow-sm border border-pink-100 text-center flex flex-col justify-between items-center">
                            <div class="flex flex-col items-center w-full">
                                ...
                                <h3 class="pink-serif text-2xl font-bold text-slate-800 mb-4">Akad Nikah</h3>
                            ...
                            ${akad.maps_url ? `
                                <a href="${akad.maps_url}" target="_blank" rel="noopener noreferrer" class="btn-pink-primary text-xs font-semibold px-6 py-3 rounded-full flex items-center gap-2">
                                    📍 Buka Google Maps
                                </a>
                            ` : ''}
                        </div>
                        ...
                        <div class="bg-white rounded-3xl p-8 shadow-sm border border-pink-100 text-center flex flex-col justify-between items-center">
                            <div class="flex flex-col items-center w-full">
                                <div class="w-16 h-16 rounded-2xl bg-wedding-secondary/60 flex items-center justify-center text-3xl text-wedding-primary mb-6">🎉</div>
                                <h3 class="pink-serif text-2xl font-bold text-slate-800 mb-4">Resepsi</h3>
                                <div class="w-12 h-[1px] bg-wedding-primary/20 mb-6"></div>
                            ...
                            ${resepsi.maps_url ? `
                                <a href="${resepsi.maps_url}" target="_blank" rel="noopener noreferrer" class="btn-pink-primary text-xs font-semibold px-6 py-3 rounded-full flex items-center gap-2">
                                    📍 Buka Google Maps
                                </a>
                            ` : ''}
                        </div>
            ...
            <section id="guestbook" class="py-24 px-4 bg-wedding-secondary/10">
                <div class="max-w-3xl mx-auto">
                    <div class="text-center mb-12">
                        <span class="text-wedding-primary pink-serif tracking-[0.2em] uppercase text-xs font-bold">Buku Tamu</span>
                        <h2 class="pink-cursive text-5xl text-wedding-primary mt-2 mb-4">Konfirmasi Kehadiran & Doa</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        ...
                        <div class="bg-white rounded-3xl p-8 shadow-sm border border-pink-100">
                            <h3 class="pink-serif text-lg font-bold text-slate-800 mb-6">Kirim Ucapan</h3>
                            <form id="rsvp-form" class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" id="rsvp-name" required value="${guestName !== 'Tamu Undangan' ? guestName : ''}" placeholder="Nama lengkap Anda..." class="w-full bg-[#FFFDFE] border border-[#FCECEF] rounded-2xl px-4 py-3 text-sm focus:outline-none focus:border-wedding-primary transition-colors text-slate-700">
                                </div>
                                
                                <div>
                                    <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Konfirmasi Kehadiran</label>
                                    <select id="rsvp-status" required class="w-full bg-[#FFFDFE] border border-[#FCECEF] rounded-2xl px-4 py-3 text-sm focus:outline-none focus:border-wedding-primary transition-colors text-slate-700">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-3 justify-between py-1" id="sticker-selector">
                                        <button type="button" data-sticker="❤️" class="sticker-btn text-2xl p-2 rounded-xl bg-[#FFFDFE] border border-slate-100 hover:scale-115 transition-transform active:bg-wedding-secondary focus:outline-none">❤️</button>
                                        <button type="button" data-sticker="🌸" class="sticker-btn text-2xl p-2 rounded-xl bg-[#FFFDFE] border border-slate-100 hover:scale-115 transition-transform active:bg-wedding-secondary focus:outline-none border-wedding-primary ring-2 ring-wedding-primary/10">🌸</button>
                                        <button type="button" data-sticker="💍" class="sticker-btn text-2xl p-2 rounded-xl bg-[#FFFDFE] border border-slate-100 hover:scale-115 transition-transform active:bg-wedding-secondary focus:outline-none">💍</button>
                                        <button type="button" data-sticker="🎉" class="sticker-btn text-2xl p-2 rounded-xl bg-[#FFFDFE] border border-slate-100 hover:scale-115 transition-transform active:bg-wedding-secondary focus:outline-none">🎉</button>
                                        <button type="button" data-sticker="🥂" class="sticker-btn text-2xl p-2 rounded-xl bg-[#FFFDFE] border border-slate-100 hover:scale-115 transition-transform active:bg-wedding-secondary focus:outline-none">🥂</button>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="rsvp-wish" required rows="4" placeholder="Tulis ucapan dan doa terbaik untuk kedua mempelai di sini..." class="w-full bg-[#FFFDFE] border border-[#FCECEF] rounded-2xl px-4 py-3 text-sm focus:outline-none focus:border-wedding-primary transition-colors text-slate-700"></textarea>
                                </div>

                                <button type="submit" class="w-full btn-pink-primary py-3.5 rounded-full text-sm font-semibold tracking-wider mt-4">
                                    KIRIM UCAPAN
                                </button>
                            </form>
                        </div>
                        ...
                        <div class="bg-white rounded-3xl p-8 shadow-sm border border-pink-100 flex flex-col h-[500px]">
                            <h3 class="pink-serif text-lg font-bold text-slate-800 mb-6 flex justify-between items-center">
                                <span>Buku Tamu</span>
            ...
            <!-- Footer -->
            <footer class="bg-[#2E2023] py-20 text-center text-slate-300">
                <div class="max-w-md mx-auto px-4">
                    <p class="pink-cursive text-4xl text-wedding-primary mb-3">Terima Kasih</p>
    ...
    const renderWishes = () => {
        ...
        wishesContainer.innerHTML = currentWishes.map(w => {
            ...
            return `
                <div class="bg-[#FFFDFE] rounded-2xl p-4 border border-[#FCECEF] relative hover:shadow-sm transition-shadow">
