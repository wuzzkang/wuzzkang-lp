        ...
        galleryHtml = `
            <section id="photo-gallery" class="py-24 px-4 bg-wedding-secondary/20 border-t border-b border-wedding-primary/5">
                <div class="max-w-4xl mx-auto text-center">
                    <span class="text-wedding-primary pink-serif tracking-[0.2em] uppercase text-xs font-bold">Galeri Foto</span>
                    <h2 class="pink-cursive text-5xl md:text-6xl text-wedding-primary mt-2 mb-12">Momen Bahagia</h2>
